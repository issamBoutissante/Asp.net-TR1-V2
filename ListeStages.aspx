...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DropDownList ID="Assocations" runat="server" DataSourceID="SqlDataSource1" DataTextField="Nam_Ass" DataValueField="Id_Ass" OnSelectedIndexChanged="Assocations_SelectedIndexChanged" AutoPostBack="True" />
    ...
    <asp:UpdatePanel runat="server">
       <ContentTemplate>
            ...
            <br />
            <br />
            <asp:Button Text="S'inscrire" runat="server" OnClick="Sinscrire_Click" ID="Sinscrire" />
        </div>
       </ContentTemplate>
        <Triggers>
